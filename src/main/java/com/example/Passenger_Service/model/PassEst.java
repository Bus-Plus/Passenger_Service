...
public class PassEst {
    ...
    public PassEst(String id, String passId, Long userId, String fromLocation, String toLocation, java.time.LocalDateTime createdAt, java.time.LocalDateTime expiry) {
        this.id = id;
        this.passId = passId;
        this.userId = userId;
